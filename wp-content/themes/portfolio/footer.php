 <footer class="container py-4">
        <div class="d-flex flex-column flex-md-row gap-4 justify-content-md-between align-items-md-center">
            <p class="text-body-tertiary text-xs leading-5 mb-0">
                ...
                Andrii Zatochnyi, Inc. All rights reserved.
            </p>
            ...
            <div class="order-first order-md-last">
                ...
                <!-- linkedIn icon -->
                <a href="https://www.linkedin.com/in/andrii-zatochniy/"
                    target="_blank"
                    class="btn bg-body-secondary text-body social my-2 p-2 me-3 rounded-circle"
                    >
                    <span class="d-flex justify-content-center align-items-center">
                ...
                <!-- github icon -->
                <a href="https://github.com/andreyz11288"
                    target="_blank"
                    class="btn bg-body-secondary text-body social my-2 p-2 me-3 rounded-circle"
                    >
                    <span class="d-flex justify-content-center align-items-center">
	...
	<script src="<?php bloginfo('template_url'); ?>/assets/libraries/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php bloginfo('template_url'); ?>/assets/libraries/glide/glide.min.js"></script>
	<script src="<?php bloginfo('template_url'); ?>/assets/libraries/aos/aos.js"></script>
